...
1. On `<body>`, add `is-special` and `data-special="<format>"` where format is one of: `countdown`, `rewind`, `versus`, `season-review`, `deep-dive`, `guide`, `starter-kit`, `shortlist`, `next`, `lookahead`, `field-guide`.
